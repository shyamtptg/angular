...
import { JobDescriptionDetails } from '../../../recruiter/models/job-description';
import { DialogService } from '../../../../../shared/dialogs/dialog.service';
import { ErrorHandleService } from '../../../../../shared/services/errorhandle.service';

@Component({
  selector: 'cpo-job-desc-modal',
  templateUrl: './job-description.component.html'
})

export class CPOJobDescModal {
  @Input() modalId: any;
  ...
  ngOnInit() {
    ...
    if (self.jobId) {
      ...
      self.hiringRequestDataService.loadJobDescriptionDataById(self.jobId).subscribe(data => {
        self.jobDescriptionData = <any>data.json();
